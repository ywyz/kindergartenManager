...
are implemented; F005 PlanPatch is a GREEN candidate, and F006 Provider/Runtime is conditionally authorized only
after F005 fixed-SHA Review/CI. F007 and later slices remain unauthorized. The Foundation is one application-layer Agent for the
