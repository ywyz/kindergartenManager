...
> 当前检出分支：`feat/agent-foundation`（F005、F006 已固定 GREEN；F007 及以后未授权）；
...
1. F006 门禁已闭合；下一步只规划 F007 的稳定 RED，取消、超时、scope/fingerprint 变化和迟到结果丢弃不得提前实现。
2. F007 若获单独授权，仍须遵循 `spec/任务 → 稳定 RED → 最小 GREEN → 双轴 Review → 固定 SHA CI`。
