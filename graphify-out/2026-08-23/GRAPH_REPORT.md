...
- One-on-One Listening Observation Subsystem
- get_current_user
- MockTransport
- AuthMiddleware
- AiParseError
...
- _build_task_panel
- Changelog
- test_prompt_from_db_overrides_default
...
### Community 1 - "Listening Exporter"
Cohesion: 0.06
...
### Community 3 - "test_export_repository.py"
Cohesion: 0.06
...
### Community 5 - "test_auth_service.py"
Cohesion: 0.10
...
### Community 7 - "test_listening_repository.py"
Cohesion: 0.10
...
### Community 9 - "verify_saved_ai_connection"
Cohesion: 0.07
...
### Community 11 - "test_generate_client.py"
Cohesion: 0.07
...
### Community 12 - "export_observation"
Cohesion: 0.11
...
### Community 14 - "test_listening_service.py"
Cohesion: 0.11
...
### Community 15 - "test_listening_ui_helpers.py"
Cohesion: 0.09
...
### Community 16 - "one_on_one_listening.py"
Cohesion: 0.11
...
Cohesion: 0.09
Nodes (23): Run migrations in 'offline' mode.      This configures the context with just a U, Run migrations in 'online' mode.      In this scenario we need to create an Engi, run_migrations_offline(), run_migrations_online(), build_sync_url(), _get_alembic_ini_path(), _get_alembic_script_location(), 应用启动模块：自动执行 Alembic 数据库迁移。 支持三种运行模式： - 开发模式（python -m… (+15 more)

### Community 18 - "pages/course_review_activity.py"
Cohesion: 0.12
...
### Community 19 - "test_config_secrets.py"
Cohesion: 0.08
...
### Community 20 - "course_review_activity_exporter.py"
Cohesion: 0.18
...
Cohesion: 0.10
Nodes (21): Path, 应用配置：通过 pydantic-settings 从 .env 文件和环境变量加载。  首次部署（无 .env 文件）时的行为： - DATABASE_URL, 返回自动生成密钥的持久化文件路径（位于用户可写数据目录）。, 解析 key=value 文件，忽略空行与注释行。, 将新键值追加/覆盖到持久化文件（已有键保留）。, 自动生成缺失的密钥并持久化，保证重启后可还原。, _read_kv_file(), _secrets_file_path() (+13 more)

### Community 23 - "CryptoError"
Cohesion: 0.12
...
### Community 28 - "test_indicator_repository.py"
Cohesion: 0.14
...
### Community 29 - "listening_service.py"
Cohesion: 0.10
...
### Community 32 - "Image Processing Utilities"
Cohesion: 0.12
...
### Community 35 - "Test Plan for One-on-One Listening Subsystem (dev3.1)"
Cohesion: 0.14
...
### Community 39 - "bootstrap_admin.py"
Cohesion: 0.17
...
### Community 41 - "pages/game_observation.py"
Cohesion: 0.17
Nodes (16): SQLAlchemy - ORM, get_class_config(), list_class_configs_for_tenant(), AsyncSession, 查询当前用户的班级配置，若不存在返回 None。, 保存班级配置：若已存在则更新，否则新建。 每个用户只保留一条班级配置记录（最新）。, API tenant 投影；可在当前 tenant 内按 user_id 进一步筛选。, upsert_class_config() (+8 more)

### Community 42 - "models/__init__.py"
Cohesion: 0.27
...
### Community 43 - "test_listening_models.py"
Cohesion: 0.12
...
### Community 44 - "generate_observation"
Cohesion: 0.14
...
### Community 48 - "mark_setup_complete"
Cohesion: 0.17
...
### Community 49 - "daily_plan_repository.py"
Cohesion: 0.21
...
### Community 50 - "课程审议 AI 结构化 JSON 合约"
Cohesion: 0.11
...
### Community 51 - "Kindergarten Management System"
Cohesion: 0.12
...
### Community 52 - "CourseReviewActivity"
Cohesion: 0.26
...
### Community 53 - "One-on-One Listening Observation Subsystem"
Cohesion: 0.11
...
### Community 58 - "split_lesson_plan"
Cohesion: 0.21
...
### Community 61 - "adapt_activity_process"
Cohesion: 0.25
...
### Community 63 - "test_observation_ui_helpers.py"
Cohesion: 0.18
...
### Community 66 - "is_adjusted_workday"
Cohesion: 0.22
...
### Community 67 - "generate_activity_content"
Cohesion: 0.24
...
### Community 69 - "test_listening_migration.py"
Cohesion: 0.17
...
### Community 71 - "test_holiday_client.py"
Cohesion: 0.27
...
### Community 74 - "rollback_to_version"
Cohesion: 0.24
...
### Community 75 - "get_active_prompt"
Cohesion: 0.31
...
### Community 77 - "generate_course_review_activity_content"
Cohesion: 0.50
...
### Community 80 - "prompt_repository.py"
Cohesion: 0.33
...
### Community 81 - "Dependency and release supply-chain threat"
Cohesion: 0.33
...
### Community 82 - "Game Observation Design Document"
Cohesion: 0.38
...
### Community 83 - "test_config_image_settings.py"
Cohesion: 0.29
...
### Community 86 - "_build_task_panel"
Cohesion: 0.33
...
### Community 88 - "test_prompt_from_db_overrides_default"
Cohesion: 0.33
...
### Community 89 - "46b9fd5613c3_add_model_name_to_ai_api_key.py"
Cohesion: 0.40
...
### Community 90 - "4e2e0e079e56_drop_invite_code_table.py"
Cohesion: 0.40
Nodes (4): downgrade(), 删除 invite_code 表（邀请码功能已移除）。, 重建 invite_code 表（回滚用）。, upgrade()

### Community 91 - "a6c4d8e2f9b1_add_course_review_activity.py"
Cohesion: 0.80
Nodes (4): downgrade(), _has_column(), _has_table(), upgrade()

### Community 92 - "game_observation_image.py"
Cohesion: 0.40
...
### Community 93 - "Homemade Teaching Toy Test Plan"
Cohesion: 0.40
...
### Community 96 - "2f7a9c1d4e8b_add_teacher_name_to_class_config.py"
Cohesion: 0.83
Nodes (3): downgrade(), _has_column(), upgrade()

### Community 97 - "7c1e2a9b5d4f_add_homemade_teaching_toy.py"
Cohesion: 0.83
Nodes (3): downgrade(), _has_table(), upgrade()

### Community 98 - "d5e4f3a2b1c0_add_homemade_teaching_id_to_export_records.py"
Cohesion: 0.83
Nodes (3): downgrade(), _has_column(), upgrade()

### Community 100 - "Service Layer"
Cohesion: 0.50
Nodes (4): Integration, NiceGUI UI, Repository, Service Layer

### Community 101 - "One-on-One Listening Progress Record"
Cohesion: 0.50
Nodes (4): One-on-One Listening Progress Record, Development Phase P0, Development Phase P1, Pick Three Workdays Function

### Community 102 - "首期产品需求文档"
Cohesion: 0.67
Nodes (4): AI 拆分、年龄适配、Word 导出与存档, 首期每日活动计划闭环, 首期产品需求文档, 角色权限与数据安全

### Community 105 - "test_dependency_security_baseline.py"
Cohesion: 0.67
...
- **Why does `Base` connect `Base` to `get_active_ai_key`, `test_export_repository.py`, `models/__init__.py`, `test_listening_models.py`, `test_indicator_repository.py`, `prompt_repository.py`, `main.py`, `pages/course_review_activity.py`, `CourseReviewActivity`, `One-on-One Listening Observation Subsystem`, `database.py`, `game_observation_image.py`, `conftest.py`, `test_migrations_smoke.py`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `read_dot_env()` connect `read_dot_env` to `one_on_one_listening.py`, `database.py`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `get_logger()` connect `exceptions.py` to `get_active_ai_key`, `Listening Exporter`, `profile.py`, `exporter.py`, `Base`, `homemade_teaching_exporter.py`, `client.py`, `AiParseError`, `AppError`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
