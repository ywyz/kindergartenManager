...
## Graph Freshness
- Built from commit: `337e4f7f`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- pages/daily_plan.py
- test_f009_zero_persistence_matrix_red.py
- Daily Plan Export
- f009_seed.py
- test_runtime_lifecycle_red.py
- runtime.py
- config.py
...
- date
- test_provider_runtime_red.py
- listening_service.py
- test_f008_tool_executor_red.py
- agent_provider.py
- Graphify Pipeline
...
- save_new_version
- AgentContext
- test_f008_provider_adapter_red.py
...
- ConfigError
- AgentReadService
- test_f008_composition_ui_red.py
...
- Frozen Agent Foundation specification
- models/__init__.py
- bootstrap_admin.py
- test_plan_patch_red.py
- read_dot_env
- update_record_with_all
- call_ai_vision
- homemade_teaching_exporter.py
- test_listening_client.py
...
- _assert_non_posix_regular_file_contract
- routes.py
- AuthMiddleware
- HomemadeTeachingToy
- mark_setup_complete
...
- DatePanel
- app_data_dir
- Homemade Teaching Toy Subsystem
- test_listening_models.py
- adapt_activity_process
- test_observation_ui_helpers.py
- hash_password
- test_f009_manual_helpers_review_red.py
- TestDatabaseConfigSave
- verify_saved_ai_connection
- generate_course_review_activity
- test_read_projections_red.py
- test_listening_migration.py
- register_user
- semester_repository.py
- DateSelection
- test_course_review_activity_ui_helpers.py
- create_api_router
- log_audit
...
- _build_task_panel
- _FailingWriteStream
- test_dependency_security_floor.py
- check_ai_endpoint
...
- ADR index
- Security lower bounds and dependency audit are production gates
...
- KindergartenManager - The Main Application
- MySQL - Database Engine
- SQLite - Database Engine
- Tenant - Multi-tenant Isolation Concept
- Controlled Agent boundary
...
- docs/ADR/ADR-0002 - Single User UI and Tenant API
...
- Test Stage P4
- Test Stage P5
- memory-bank/implementation-plan.md - Implementation Plan (Historical)
...
- KindergartenManager architecture overview
...
- `test_each_read_tool_returns_one_closed_projection_from_one_short_session()` --uses--> `CalendarEvaluationProjection`  [INFERRED]
  specs/agent-foundation/tests/test_f008_tool_executor_red.py → app/service/agent/contracts.py
- `test_controller_builds_fresh_actor_scoped_context_and_short_lived_credentials()` --uses--> `DailyPlanProjection`  [INFERRED]
  specs/agent-foundation/tests/test_f008_composition_ui_red.py → app/service/agent/contracts.py
- `test_each_read_tool_returns_one_closed_projection_from_one_short_session()` --uses--> `DailyPlanProjection`  [INFERRED]
  specs/agent-foundation/tests/test_f008_tool_executor_red.py → app/service/agent/contracts.py
- `_projection()` --uses--> `DailyPlanProjection`  [INFERRED]
  specs/agent-foundation/tests/test_f009_zero_persistence_matrix_red.py → app/service/agent/contracts.py
...
### Community 0 - "pages/daily_plan.py"
Cohesion: 0.04
...
### Community 1 - "test_f009_zero_persistence_matrix_red.py"
Cohesion: 0.07
...
### Community 4 - "test_runtime_lifecycle_red.py"
Cohesion: 0.10
...
### Community 7 - "listening_exporter.py"
Cohesion: 0.06
...
### Community 13 - "test_auth_service.py"
Cohesion: 0.09
...
### Community 15 - "test_provider_runtime_red.py"
Cohesion: 0.17
...
### Community 16 - "listening_service.py"
Cohesion: 0.09
...
### Community 17 - "test_f008_tool_executor_red.py"
Cohesion: 0.12
...
### Community 18 - "agent_provider.py"
Cohesion: 0.08
...
### Community 19 - "Graphify Pipeline"
Cohesion: 0.04
...
### Community 20 - "test_listening_service.py"
Cohesion: 0.07
...
### Community 22 - "test_generate_client.py"
Cohesion: 0.07
...
### Community 26 - "test_f008_provider_adapter_red.py"
Cohesion: 0.17
...
### Community 27 - "one_on_one_listening.py"
Cohesion: 0.09
...
### Community 28 - "export_observation"
Cohesion: 0.11
...
### Community 31 - "test_migrations_smoke.py"
Cohesion: 0.09
...
### Community 39 - "AgentProviderPort"
Cohesion: 0.08
...
### Community 46 - "test_indicator_repository.py"
Cohesion: 0.17
...
### Community 48 - "Test Plan for One-on-One Listening Subsystem (dev3.1)"
Cohesion: 0.14
...
### Community 49 - "Frozen Agent Foundation specification"
Cohesion: 0.16
...
### Community 51 - "bootstrap_admin.py"
Cohesion: 0.17
...
### Community 54 - "update_record_with_all"
Cohesion: 0.13
...
### Community 58 - "daily_plan_repository.py"
Cohesion: 0.20
...
### Community 60 - "课程审议 AI 结构化 JSON 合约"
Cohesion: 0.11
...
### Community 61 - "Kindergarten Management System"
Cohesion: 0.12
...
### Community 62 - "CourseReviewActivity"
Cohesion: 0.26
...
### Community 63 - "process_lesson_plan"
Cohesion: 0.20
...
### Community 64 - "run_startup_migrations"
Cohesion: 0.15
...
### Community 65 - "DailyPlanAgentPanel"
Cohesion: 0.18
...
### Community 66 - "_assert_failure_is_sanitized"
Cohesion: 0.15
...
### Community 67 - "_assert_non_posix_regular_file_contract"
Cohesion: 0.20
...
### Community 70 - "HomemadeTeachingToy"
Cohesion: 0.28
...
### Community 71 - "mark_setup_complete"
Cohesion: 0.21
...
### Community 72 - "generate_observation"
Cohesion: 0.18
...
### Community 75 - "Homemade Teaching Toy Subsystem"
Cohesion: 0.15
...
### Community 76 - "test_listening_models.py"
Cohesion: 0.16
...
### Community 77 - "adapt_activity_process"
Cohesion: 0.25
...
### Community 78 - "test_observation_ui_helpers.py"
Cohesion: 0.18
...
### Community 80 - "test_f009_manual_helpers_review_red.py"
Cohesion: 0.24
...
### Community 81 - "TestDatabaseConfigSave"
Cohesion: 0.21
...
### Community 82 - "verify_saved_ai_connection"
Cohesion: 0.26
...
### Community 83 - "generate_course_review_activity"
Cohesion: 0.41
...
### Community 84 - "test_read_projections_red.py"
Cohesion: 0.36
...
### Community 85 - "test_listening_migration.py"
Cohesion: 0.17
...
### Community 87 - "semester_repository.py"
Cohesion: 0.31
...
### Community 89 - "test_course_review_activity_ui_helpers.py"
Cohesion: 0.29
...
### Community 90 - "create_api_router"
Cohesion: 0.28
...
### Community 92 - "test_config_secrets.py"
Cohesion: 0.11
...
### Community 93 - "listening_client.py"
Cohesion: 0.29
...
### Community 97 - "check_ai_endpoint"
Cohesion: 0.43
...
### Community 98 - "Game Observation Design Document"
Cohesion: 0.38
...
### Community 99 - "test_config_image_settings.py"
Cohesion: 0.29
...
### Community 106 - "46b9fd5613c3_add_model_name_to_ai_api_key.py"
Cohesion: 0.40
...
### Community 107 - "4e2e0e079e56_drop_invite_code_table.py"
Cohesion: 0.40
Nodes (4): downgrade(), 删除 invite_code 表（邀请码功能已移除）。, 重建 invite_code 表（回滚用）。, upgrade()

### Community 108 - "a6c4d8e2f9b1_add_course_review_activity.py"
Cohesion: 0.80
Nodes (4): downgrade(), _has_column(), _has_table(), upgrade()

### Community 109 - "Homemade Teaching Toy Test Plan"
Cohesion: 0.40
...
### Community 136 - "Contributing guide"
Cohesion: 0.67
...
### Community 137 - "ADR-0004 AI and fixed Word boundaries"
Cohesion: 0.67
...
- **Why does `TrustedActor` connect `composition.py` to `pages/daily_plan.py`, `test_f009_zero_persistence_matrix_red.py`, `AgentReadService`, `test_f008_composition_ui_red.py`, `test_runtime_lifecycle_red.py`, `runtime.py`, `contracts.py`, `read_service.py`, `test_provider_runtime_red.py`, `test_f008_tool_executor_red.py`, `test_plan_patch_red.py`, `test_f008_provider_adapter_red.py`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `save_daily_plan()` connect `f009_seed.py` to `pages/daily_plan.py`, `daily_plan_repository.py`?**
