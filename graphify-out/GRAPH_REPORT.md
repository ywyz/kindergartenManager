...
- Token cost: 13,729 input · 13,751 output
...
### Community 1 - "Listening AI Client"
Cohesion: 0.06
...
### Community 3 - "Date Calculation Service"
Cohesion: 0.08
...
### Community 4 - "AI Client Infrastructure"
Cohesion: 0.09
...
### Community 9 - "Listening Repository"
Cohesion: 0.10
...
### Community 10 - "Data Access Layer"
Cohesion: 0.10
Nodes (28): AsyncSessionUnitOfWork, AsyncSession, SQLAlchemy 异步会话的最外层 Unit of Work。, 在一个 use-case 结束时统一提交，任一步失败时统一回滚。, add_image(), delete_images_by_record(), AsyncSession, listening_image_repository — 一对一倾听图片数据访问层。 (+20 more)
...
Cohesion: 0.17
Nodes (19): create_user(), get_user_by_id(), 创建用户并持久化到数据库，返回已持久化的 User 对象。, 在指定租户下按 ID 查询用户，不存在时返回 None。, 在指定租户中更新用户哈希密码，返回是否更新成功。, update_password(), 用户仓库层集成测试（SQLite 内存库）。, 支持用户名关键字筛选和分页，且总数统计正确。 (+11 more)
...
### Community 59 - "Holiday Name Lookup"
Cohesion: 0.24
...
Cohesion: 0.18
Nodes (13): get_image(), 按 id 查询单张图片，强制 tenant_id 过滤。, aiosqlite In-Memory Database Fixture, pytest Test Framework, ListeningImage, Test Plan for One-on-One Listening Subsystem (dev3.1), One-on-One Listening Subsystem, Phase P2: Repository Layer (+5 more)
...
### Community 99 - "API Database Dependency"
Cohesion: 0.40
...
### Community 106 - "Export Record Migration"
Cohesion: 0.83
Nodes (3): downgrade(), _has_column(), upgrade()
...
### Community 130 - "Agent Contribution Rules"
Cohesion: 0.67
...
### Community 131 - "AI Boundary ADRs"
Cohesion: 0.67
...
### Community 132 - "Agent Registry ADRs"
Cohesion: 0.67
Nodes (3): Accepted ADR-0005 Agent registry entry, Agent Tool, permission, memory, or write changes require a new ADR, ADR index

### Community 133 - "Service Decomposition Docs"
Cohesion: 1.00
Nodes (3): Future Microservice Decomposition, Main Application (app/integration/), Services Directory Status README

### Community 134 - "Daily Activity Prompts"
Cohesion: 0.67
Nodes (3): 一日活动节假日语义, 一日活动提示词版本管理, 一日活动提示词与一键生成

### Community 135 - "Homemade Teaching Feature"
Cohesion: 1.00
Nodes (3): Homemade Teaching Design Document, Generate Homemade Teaching Function, Homemade Teaching Toy Table

### Community 189 - "Prompt Template Task Types"
Cohesion: 0.40
Nodes (5): PromptTemplate, PromptTemplate 可保存 task_type='game_observation'。, PromptTemplate 可保存 task_type='course_review_activity'。, test_prompt_template_course_review_activity_task_type(), test_prompt_template_game_observation_task_type()
...
- **Why does `Base` connect `Database Models` to `Async Test Fixtures`, `Export Record Repository`, `API Response Schemas`, `Course Review Repository`, `User Bootstrap`, `Listening Data Models`, `Prompt Template Task Types`, `Homemade Teaching Repository`, `Indicator Repository`, `Alembic Migration Env`, `AI Key Repository`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `save_ai_key()` connect `AI Key Repository` to `AI Endpoint Verification`, `Encryption Utilities`, `Observation Generation Service`, `Listening Service Tests`, `AI Key Repository Tests`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `log_audit()` connect `Audit and User Admin` to `Admin Bootstrap Script`, `User Registration`, `AI Client Infrastructure`, `External REST API`, `Daily Activity Service`, `Course Review Service`, `Authentication Service`, `Data Access Layer`, `Observation Generation Service`, `Homemade Teaching Service`, `Password Hashing`?**
