...
def get_ai_client(api_key=None, base_url=None):
    ...
    if not api_key:
        raise ValueError("未提供 API Key，请通过参数或环境变量 OPENAI_API_KEY 设置")
...
def split_collective_activity(draft_text, api_key=None, base_url=None, model=None, system_prompt=None):
    """
    使用AI拆分集体活动原稿
