...
- 当前代码状态：P1~P6 已实现并通过自动测试；页面主流程已由用户手动测试通过。
...
| P5 | UI 页面与导航 | 完成，手动验收通过 | `tests/test_homemade_teaching_ui_helpers.py` 5 passed；`tests/test_app_shell_menu.py` 9 passed |
...
| 2026-06-28 | 用户手动验收 | 设置、运行与主流程测试通过 |
