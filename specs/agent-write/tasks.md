...
| W009 | merge、Issue 关闭与发布 | W008 全门禁闭合 + 单独授权 | 已授权；等待 PR #53 与 release-readiness finding 修正后的 W008 新 SHA 全部门闭合，再按 merge、merge-SHA Review/CI、Issue 关闭、release 顺序执行 |
