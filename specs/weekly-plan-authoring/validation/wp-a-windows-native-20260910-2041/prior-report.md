...
short/compact 各1页；long 各2页，明确单页失败。**Windows Word 子门仍 BLOCKED**：原生画面工具不可用，
修复/兼容警告、打印预览及字体替换观察待用户补充；用户答应稍后补充，不等于已经完成。
...
| 原生观察 | Computer Use初始/重试/重置重试均native pipe os error2，未取得Word画面/截图；不可声称无修复或替换警告 |
...
下表F=可见文字为嵌入宋体，纯空格含Times New Roman、原生字体替换检查待补；
V=独立逐页审图未见裁切/重叠/左右溢出；C=固定数量全部完整，详见下一节。
所有短/compact的“可行”均只指当前合成候选PDF；其Windows完整子门仍待原生观察/字体问题闭合。

| 输入 | input SHA256 | Word/PDF页数 | 字体 | 裁切/溢出 | 固定数量 | 本轮结论/理由 | 证据子目录 |
|---|---|---:|---|---|---|---|---|
| normal-five-short.docx | `7eca517011011b5cb7c3b74d38756fdfef6da5f2a7df44503bceefdbd07593c9` | 1/1 | F | V | C | 单页PDF可行；原生门BLOCKED | normal-five-short/ |
...
| preceding-sunday-six-short.docx | `78b7f8fdab2714a4cb4a5cacfaba55092229462653811ce66503d61e2ff1109a` | 1/1 | F | V | C | 单页PDF可行；原生门BLOCKED | preceding-sunday-six-short/ |
...
| saturday-six-short.docx | `99bfb2d7be462be4353a5b54affddac60c4bd257040f4a6e237f5bbd58073259` | 1/1 | F | V | C | 单页PDF可行；原生门BLOCKED | saturday-six-short/ |
...
详见[独立Review](WP-A-Windows-20260910-review.md)。Review范围不包含不可用的原生Word画面。
...
| 门 | 本轮状态与下一步 |
|---|---|
| Windows Word子门 | BLOCKED：已有9PDF/12PNG/页数与视觉；待原生打开/警告/打印预览、全文字体差异核实；long单页FAIL保留 |
...
> 续接WP-A-Windows-20260910账本，先补九份同hash DOCX在真实Word中的逐份打开、警告/字体替换及打印预览观察，
...
尚未回写#77：用户要求证据完整后回写，原生观察已经请求且用户表示稍后补充，当前仍待结果。
